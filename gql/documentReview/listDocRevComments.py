...
payload = "{\"query\":\"query ListDocumentReviewComments($action: String!, $payload: JSON!)\\n{\\n    genericActionCall(action: $action, payload: $payload)\\n    {\\n    result\\n    __typename\\n    }    \\n}\",\"variables\":{\"action\":\"Listcommentsfordocumentreview\",\"payload\":{\"id\":\"7e94bae0-0c0f-4091-bb35-d17d86636a14\",\"processType\":\"documentReview\"}}}"
headers = {
