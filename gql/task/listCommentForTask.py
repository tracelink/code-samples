...
payload = "{\"query\":\"mutation ListCommentForTask($action: String!, $payload: JSON!)\\n{\\n    genericActionCall(action: $action, payload: $payload)\\n    {\\n    result\\n    __typename\\n    }    \\n}\",\"variables\":{\"action\":\"Listcommentsforprocess\",\"payload\":{\"processId\":\"522a98e1-c301-4f07-8cc5-0862b08a4886\",\"processType\":\"task\"}}}"
headers = {
