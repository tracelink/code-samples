...
payload = "{\"query\":\"mutation AddTaskTemplate($action: String!, $payload: JSON!)\\n{\\n    genericActionCall(action: $action, payload: $payload)\\n    {\\n    result\\n    __typename\\n    }    \\n}\",\"variables\":{\"action\":\"Addtasktemplate\",\"payload\":{\"templateName\":\"GQL Python Created Task Template 1\",\"aptBusinessObjectDescription\":\"Template to demonstrate creation via GraphQL API and Python\",\"isTemplateModifiableByMember\":true,\"isAddRemoveSubtaskAllowed\":true,\"completionRequiredWithinDays\":14,\"businessPriority\":\"LOW\"}}}"
headers = {
