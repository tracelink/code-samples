...
payload = "{\"query\":\"mutation AddComplianceException($action: String!, $payload: JSON!)\\n{\\n    genericActionCall(action: $action, payload: $payload)\\n    {\\n    result\\n    __typename\\n    }    \\n}\",\"variables\":{\"action\": \"Addcomplianceexception\",\"payload\":{\"aptBusinessObjectSummary\": \"GraphQL flow test run 1\",\"aptBusinessObjectDescription\":\"Adding a compliance exception incident programmatically from postman using graphQL walkthrough demo.\",\"businessPriority\":\"MEDIUM\",\"resolutionDueDate\":\"1736613281000\"}}}"
headers = {
